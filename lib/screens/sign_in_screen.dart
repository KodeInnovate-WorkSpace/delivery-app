...
class _SigninScreenState extends State<SigninScreen> {
  ...
  void initState() {
    ...
    authProvider.textController.addListener(() {
      setState(() {
        authProvider.isButtonEnabled =
            authProvider.textController.text.length == 10;
      });
    });
  }
                    ...
                    children: [
                      ...
                      ElevatedButton(
                        onPressed: authProvider.isButtonEnabled
                          ...
                          await userProvider.doesUserExists(
                              authProvider.phone!, context);
                          ...
                          if (userProvider.isUserExist) {
                            ...
                            Navigator.pushReplacement(
                                ...
                                MaterialPageRoute(builder: (context) =>
                                    EmailScreen(phoneNumber: authProvider
                                        .phone)));
