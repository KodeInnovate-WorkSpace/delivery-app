...
//     try {
//       final snapshot = await FirebaseFirestore.instance.collection("Advertisement").get();
//
//       if (snapshot.docs.isNotEmpty) {
//         setState(() {
...
//               advertisementImages.add(imageUrl);
//             }
//           }
//         });
//       } else {
//         log("No Advertisement Document Found!");
//       }
//     } catch (e) {
...
//
//
//   void startAdvertisementScroll() {
//     Future.delayed(const Duration(seconds: 2), () {
//       if (mounted) {
//         setState(() {
//           currentAdvertisementIndex =
//               (currentAdvertisementIndex + 1) % advertisementImages.length;
//         });
//         startAdvertisementScroll();
//       }
//     });
...
class _HomePageState extends State<HomeScreen> {
  final GlobalKey<ScaffoldState> scaffoldKey = GlobalKey<ScaffoldState>();
  late Future<void> fetchDataFuture;
  final List<Category> categories = []; // Fetch these from your API or database
  final List<SubCategory> subCategories = []; // Fetch these from your API or database
  final String deliveryTime = "20"; // This should be dynamic as per your requirement

  @override
  void initState() {
    super.initState();
    fetchDataFuture = fetchData(); // Replace with your data fetching logic
  }
                          ...
                          badges.Badge(
                            badgeContent: Padding(
                              ...
                              child: Text(
                                itemCount.toString(),
                                style: const TextStyle(
                                    color: Colors.white, fontFamily: 'Gilroy-SemiBold', fontSize: 10),
                              ),
                            ),
