  ...
  Future<void> checkAppMaintenanceStatus(BuildContext context) async {
    try {
      ...
      final specificNumber =
          Provider.of<MyAuthProvider>(context, listen: false).specificNumber;
        ...
        return SliverList(
          delegate: SliverChildBuilderDelegate(
            (context, index) {
              ...
              return Container(
                color:
                    Color(int.parse(alert['color'].replaceFirst('#', '0xff'))),
                  ...
                  child: Text(
                    ...
                    style: TextStyle(
                      color: Color(int.parse(
                          alert['textcolor'].replaceFirst('#', '0xff'))),
                      fontSize: 14,
                  ...
                  return Column(
                    children: categories.map((category) {
                      final filteredSubCategories = subCategories
                          ...
                          .toList();
                      final itemCount = filteredSubCategories.length < 4
                      ...
                      return Stack(
                        children: [
                          ...
                          Padding(
                            padding: category.logoUrl != null
                                ? const EdgeInsets.only(
                                    top:
                                        25.0) // Add space only for categories with logo
                                : EdgeInsets.zero,
                          ...
                          Positioned(
                            ...
                            top: category.logoUrl != null
                                ? 0
                                : -10, // Adjust based on logo presence
                            child: Align(
