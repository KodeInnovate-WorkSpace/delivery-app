...
//   }
//
//   void _incrementCount(CartProvider cartProvider, Cart cartItem) {
//     setState(() {
//       _count++;
//       _isClicked = true;
//     });
...
//   }
//
//   void _decrementCount(CartProvider cartProvider, Cart cartItem) {
//     setState(() {
//       if (_count > 1) {
//         _count--;
//         cartProvider.removeItem(cartItem);
...
//                     icon:
//                         const Icon(Icons.remove, size: 15, color: Colors.white),
//                     onPressed: () => _decrementCount(cartProvider, cartItem),
//                   ),
//                 ),
//                 Text(
//                   _count.toString(),
...
//                     constraints: const BoxConstraints(),
//                     icon: const Icon(Icons.add, size: 15, color: Colors.white),
//                     onPressed: () => _incrementCount(cartProvider, cartItem),
//                   ),
//                 ),
//               ],
//             ),
